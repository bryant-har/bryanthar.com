  ...
  return <div>
    <section className="section font-light">
      ...
      <div className="mb-4">
        ...
        <p className="text-sm font-serif italic">B.S. in Computer Science, Engineering Physics, English</p>
      </div>
      <div>
        <p className='font-normal link text-md'><a href='#coursework'>Technical Coursework</a></p>
        <p className="text-sm font-serif italic">Award for Excellence in Physics, Deans List, all years eligible.</p>
      </div>
    ...
    <section className='layout pb-12'><h1 className="heading "><span className='text-teal-600'>#</span> Fun Facts </h1>
